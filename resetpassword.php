...
$query = "SELECT * FROM admin_details WHERE adminemail = '$email' AND adminpass = '$old_password'";
$res = $con->query($query);

if ($res->num_rows > 0) {
    $update_query = "UPDATE admin_details SET adminpass = '$new_password' WHERE adminemail = '$email'";
